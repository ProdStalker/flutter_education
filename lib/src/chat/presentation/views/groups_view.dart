...
import 'package:education/src/chat/presentation/widgets/other_group_tile.dart';
import 'package:education/src/chat/presentation/widgets/your_group_tile.dart';
        ...
        builder: (context, state) {
          if (state is LoadingGroups) {
            ...
            return const NotFoundText(
              ...
              (yourGroups.isNotEmpty || otherGroups.isNotEmpty)) {
            return ListView(
