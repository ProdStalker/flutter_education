...
import 'package:education/src/chat/presentation/refactors/chat_app_bar.dart';
import 'package:education/src/chat/presentation/widgets/chat_input_field.dart';
import 'package:education/src/chat/presentation/widgets/message_bubble.dart';
          ...
          if (state is LoadingMessages) {
            ...
            return Column(
              children: [
                ...
                BlocProvider(
                  create: (_) => sl<ChatCubit>(),
                  child: ChatInputField(widget.group.id),
                ),
              ],
            );
          }
