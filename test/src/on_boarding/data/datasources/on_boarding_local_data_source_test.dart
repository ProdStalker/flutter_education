...
void main() {
  ...
  group('checkIfUserIsFirstTimer', () {
    test(
        ...
        'return the right response from stroage when data exists', () async {
    ...
    test('should return true if there is not data in storage', () async {
    ...
    test(
      'should throw a [CacheException] when there is an error retrieving the '
      'data',
      () async {
